...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
    ...
    <div class="mdl-cell mdl-cell--8-col mdl-card" style="display:none" id="msg_board1"><h4 class="mdl-color-text--red" id="msg_board" ></h4></div>
     <div class="mdl-card mdl-shadow--2dp mdl-cell mdl-cell--8-col">
     <div class="mdl-card__title mdl-color--primary mdl-color-text--white">
            <h2 class="mdl-card__title-text">Forget Password</h2>
        </div>
  <div class="mdl-card__supporting-text">
  <h4>Enter your email,a email with 6 digit OTP will be send to this email</h4>
     <form id="pwd_form" >
     <div id="err_2" style="display:none"></div>
     <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
     <label class="mdl-textfield__label">Email</label>
    <input type="email" class="mdl-textfield__input" id="email" name="email12">
    </div>
    <input type="submit" id="fget" class="mdl-button mdl-button--colored mdl-button--raised mdl-js-button mdl-js-ripple-effect">
    </form>
    </div>
    </div>
    </div>

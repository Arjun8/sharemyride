...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
  ...
  <h4>A OTP has been sent to you.Enter the OTP that was sent to you</h4>
     <div id="otp2" style="display:none"></div>
     <form id="otp5">
     <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" id="otp1">
     <label class="mdl-textfield__label">OTP</label>
    <input type="number" class="mdl-textfield__input" id="otp" name="otp" pattern="[0-9]{6}">
    </div>
    <input type="submit" id="otp_button" class="mdl-button mdl-button--colored mdl-button--raised mdl-js-button mdl-js-ripple-effect" name="otp_button">
    </form>
    <form id="reset"style="display:none;">
    ...
    <input type="text" class="mdl-textfield__input" id="pwd" name="pwd" >
    </div>
    <div id="err_4" style="display:none"></div>
    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
     <label class="mdl-textfield__label">Confirm Password</label>
    <input type="text" class="mdl-textfield__input" id="cpwd" name="cpwd" >
    </div>
